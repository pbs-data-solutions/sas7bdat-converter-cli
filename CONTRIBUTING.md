...
The best place to start is to check the [issues](https://github.com/pbs-data-solutions/sas7bdat-converter-cli/issues)
...
```sh
git clone git@github.com:your-user-name/sas7bdat-converter-cli
cd sas7bdat-converter-cli
git remote add upstream git@github.com:pbs-data-solutions/sas7bdat-converter-cli
```

This creates the directory sas7bdat-converter-cli and connects your repository to the upstream
...
# Run black
poetry run black sas7bdat_converter_cli tests
...
[main github page](https://github.com/pbs-data-solutions/sas7bdat-converter-cli). You can run tests
and see the code coverage by running:
...
After pushing your code to origin it is now on GitHub but not yet part of the sas7bdat-converter-cli
...
of the sas7bdat-converter-cli project know you have code ready to be reviewed. To submit the pull
request:
